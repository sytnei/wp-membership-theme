 ...
 */
function wp_membership_theme_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'wp-membership-theme' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'wp-membership-theme' ),
...
add_action( 'widgets_init', 'wp_membership_theme_widgets_init' );
...
function wp_membership_theme_scripts() {
	...
	wp_enqueue_script( 'wp-membership-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'wp-membership-theme-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
